...
# id patane
# cd /tmp && wget https://raw.githubusercontent.com/wimpysworld/obs-fully-loaded/main/obs-install.sh && chmod +x obs-install.sh && su $USER -c 'sudo -S /tmp/obs-install.sh'
